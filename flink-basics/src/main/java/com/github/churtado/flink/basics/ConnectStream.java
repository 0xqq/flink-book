...
import com.github.churtado.flink.basics.util.SensorReading;
import com.github.churtado.flink.basics.util.SensorSource;
import com.github.churtado.flink.basics.util.SensorTimeAssigner;
...
/**
 * Here we see how to connect streams of data together.
 * In the first instance, data is just shuffled together randomly
 * In the second, streams are joined by keys
 * In the third, one stream is broadcast to all operators of the other
 */
...
public class ConnectStream {
    public static void main(String[] args) throws Exception {
        ...
        ConnectedStreams<SensorReading, SensorReading> connected2 = first
                .connect(second)
                .keyBy("id", "id");
...
//        .print();
        ...
        ConnectedStreams<SensorReading, SensorReading> connected3 = first
